  ...
  return (
    <div className="space-y-6">
      ...
      <div
        ...
        className={`relative rounded-2xl border-2 border-dashed p-8 md:p-12 text-center transition-all duration-200 cursor-pointer overflow-hidden ${
          dragActive
        ...
        <div className="relative z-10 flex flex-col items-center justify-center space-y-4">
          {selectedFile ? (
            ...
            <>
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-100 border border-slate-200 text-xs text-slate-600 font-medium">
        ...
        <div className="flex items-center gap-3.5 text-left">
          ...
          <div>
            <h4 className="text-sm font-bold text-slate-900 flex items-center gap-2">
              ...
              <span className="text-xs text-indigo-600 font-semibold">demo_enterprise_repo</span>
            </h4>
            <p className="text-xs text-slate-500 mt-0.5">
