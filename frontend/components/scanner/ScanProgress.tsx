    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="nexus-card p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-sky-500/10 border border-sky-500/30 flex items-center justify-center text-sky-400 shadow-[0_0_12px_rgba(56,189,248,0.2)]">
        ...
        {/* Progress Track */}
        <div className="w-full bg-[#050B14] border border-slate-800 rounded-full h-2.5 overflow-hidden p-0.5">
          <div
            className="h-full bg-sky-400 rounded-full transition-all duration-150 shadow-[0_0_10px_rgba(56,189,248,0.8)]"
            ...
            <div
              ...
              className={`p-3.5 rounded-xl border flex items-center gap-3 transition-all ${
                isDone
                  ...
                  : isRunning
                  ? "bg-sky-950/40 border-sky-400 text-sky-200 shadow-[0_0_15px_rgba(56,189,248,0.15)]"
                  : "bg-[#0A1424]/90 border-slate-800 text-slate-500"
              }`}
            >
              ...
              <div className="truncate">
                <p className="text-xs font-semibold truncate text-white">{step.label}</p>
      ...
      <div className="nexus-card overflow-hidden font-mono text-xs">
        <div className="bg-[#060e1a]/90 px-4 py-2.5 border-b border-slate-800 flex items-center justify-between">
          ...
          <span className="text-[10px] text-slate-400 font-mono">Live stdout</span>
        </div>

        <div className="p-4 h-48 overflow-y-auto space-y-1.5 bg-[#050B14] text-slate-300">
          {logs.map((log, idx) => (
