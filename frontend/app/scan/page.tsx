      ...
      {isScanning ? (
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
            <div className="nexus-card p-4 space-y-1.5">
              <div className="w-7 h-7 rounded-lg bg-slate-100 text-slate-700 flex items-center justify-center">
                <FileCode className="w-3.5 h-3.5" />
              </div>
              <h4 className="font-bold text-slate-900">AST & Binary Parser</h4>
            ...
            <div className="nexus-card p-4 space-y-1.5">
              ...
              <h4 className="font-bold text-slate-900">AI Semantic Discovery</h4>
              <p className="text-[11px] text-slate-500 leading-relaxed">
            ...
            <div className="nexus-card p-4 space-y-1.5">
              ...
              <h4 className="font-bold text-slate-900">CycloneDX 1.6 CBOM</h4>
              <p className="text-[11px] text-slate-500 leading-relaxed">
