...
| 2 | **Ojasya Rajput** | **Engineering** | **Backend Dev 2** (CycloneDX 1.6 CBOM Exporter, AI Remediation, PDF Reports) | [`Ojasya_Rajput_BackendDev2.md`](./Ojasya_Rajput_BackendDev2.md) |
...
- **🛠️ Engineering Track (3 Members):**
  ...
  - **Ojasya Rajput:** CycloneDX 1.6 CBOM generator, AI semantic analysis, AI 1-click code remediation, and PDF audit reports.
